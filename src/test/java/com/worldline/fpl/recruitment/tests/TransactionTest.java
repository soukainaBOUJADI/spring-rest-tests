...
public class TransactionTest extends AbstractTest {
	...
	public void removeTransaction() throws Exception {
		mockMvc.perform(get("/accounts/1/transactions/delete/1")).andExpect(status().isOk());
	}

	@Test
	public void removeTransactionNoContentWithId() throws Exception {
		mockMvc.perform(get("/accounts/1/transactions/delete/6")).andExpect(status().isNoContent());
	}
